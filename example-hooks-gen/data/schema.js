...
const GraphQLSetAppendingMutation = {
  name: "SetAppending",
  type: GraphQLUser,
  args: {
    appending: { type: new GraphQLNonNull(GraphQLBoolean) },
  },
  resolve: (source, args) => {
    setIsAppending(args.appending)
    return getViewer()
  },
}
...
const Mutation = new GraphQLObjectType({
  ...
  fields: {
    ...
    setAppending: GraphQLSetAppendingMutation,
  },
})
